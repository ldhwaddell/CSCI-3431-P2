...
void createGraph(int numBuses, int matrix[][NUM_DIRECTIONS], int adj_matrix[][ADJ_COLS])
{
...
int checkDeadlock(int numBuses, int adj_matrix[][ADJ_COLS])
{
...
int main(int argc, char *argv[])
{
    ...
    int adj_matrix[numBuses + 4][ADJ_COLS];
